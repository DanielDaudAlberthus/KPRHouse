...
@section('content')
    ...
    <main class="flex min-h-screen">
            ...
            <div class="relative flex w-full max-w-[640px]">
                <div class="h-screen w-full max-w-[640px] overflow-hidden">
                    <img src="assets/images/backgrounds/login-banner.png" class="w-full h-full object-cover rounded-[20px] shadow-2xl scale-[1.02] transform transition-all duration-500 ease-in-out hover:scale-105 hover:shadow-[0px_20px_50px_rgba(0,0,0,0.3)]"
                    alt="banner">
