<nav class="relative w-full flex items-center justify-center px-[75px] shadow-md bg-white-z-50">
            <div class="top-0 flex items-center justify-between w-full max-w-[1130px] p-4 mt-[20px] z-30">
                ...
                @guest
                    <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('register') }}" class="group rounded-full border py-[14px] px-5 flex items-center bg-tedja-blue">
