            ...
            <main class="flex w-full flex-col justify-center gap-[30px]  py-[28px]">
                <header class="flex items-center justify-between">
                    ...
                    <div class="buttons flex gap-[12px]">
                        <button type="button" class="font-semibold text-white rounded-full py-[14px] px-5 bg-tedja-black transition-all duration-300">
                            Export to
                        </button>
                ...
                <section id="Cards" class="flex flex-col gap-[30px]">
                    ...
                    <div
                        ...
                        <div class="w-[150px] h-[168px] shrink-0 rounded-[30px] overflow-hidden flex justify-center items-center">
                            <img src="{{ Storage::url($mortgage->house->thumbnail) }}" alt="image" class="w-full h-full object-cover">
                        </div>
                        <div class="px-[10px] flex flex-col gap-[18px] w-full">
                            <div class="title flex flex-col gap-[6px]">
                                ...
                                <div class="flex items-center gap-[6px]">
                                    <img src="{{ asset('assets/images/icons/location.svg') }}" alt="icon" class="shrink-0 size-5">
                            ...
                            <div class="points grid grid-cols-3 gap-x-[18px] gap-y-[12px]">
                                <div
                                    ...
                                    <p class="font-semibold text-sm leading-[21px]">
                                        {{ $mortgage->house->bedroom }} Bedroom
                                    </p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
                                ...
                                <div
                                    ...
                                    <img src="{{ asset('assets/images/icons/slider-horizontal.svg') }}" alt="icon"
                                        class="shrink-0 size-5">
                                    <p class="font-semibold text-sm leading-[21px]">
                                        {{ $mortgage->house->bathroom }} Bathroom
                                    </p>
                                </div>
                                <div
                                    class="flex items-center gap-[6px] p-[10px] border border-[#F2F2F4] rounded-[14px]">
