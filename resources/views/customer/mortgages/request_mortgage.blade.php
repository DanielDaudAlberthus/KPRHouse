...
@section('content')
<x-nav-tedja/>
    <div class="relative w-full max-w-[1280px] px-[75px] mt-[164px] flex flex-col gap-[6px] text-center items-center mx-auto">
            <h1 class="font-bold text-4xl leading-[54px]">Request for Mortgage</h1>
            <p>We will give you best of life forever young yay</p>
            <a href="{{ route('front.details', $interest->house->slug) }}" class="absolute transform -translate-y-1/2 top-1/2 left-[75px] flex items-center gap-[6px] hover:text-tedja-blue transition-all duration-300">
        ...
        <div class="flex justify-center gap-[30px] mt-[50px] mb-[70px]">
            ...
            <div class="flex flex-col gap-5 w-[500px] shrink-0">
                <section id="Price-Details" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-4">
                ...
                <section id="Bank-Details" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-4">
                    <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-4" id="BankDetails">
                        ...
                        <div class="flex flex-col gap-4">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <strong class="font-semibold">
                                    {{ $interest->duration }} Years</strong>
                            </div>
                        </div>
                    </div>
                </section>
                <section id="Choose-Amount" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-4">
                    <h4 class="font-semibold text-lg leading-[27px]">Choose DP Amount</h4>
                    <div class="grid grid-cols-3 gap-y-4 gap-x-5" id="dp-options">
                        <a href="#" data-percentage="10" class="dp-option group relative rounded-[14px] border border-tedja-border py-[14px] px-[10px] flex items-center justify-center hover:bg-tedja-black transition-all duration-300">
                            <span class="font-semibold group-hover:text-white transition-all duration-300">10%</span>
                        </a>
                        <a href="#" data-percentage="20" class="dp-option group relative rounded-[14px] border border-tedja-border py-[14px] px-[10px] flex items-center justify-center hover:bg-tedja-black transition-all duration-300">
                            <span class="font-semibold group-hover:text-white transition-all duration-300">20%</span>
                        </a>
                        <a href="#" data-percentage="40" class="dp-option group relative rounded-[14px] border border-tedja-border py-[14px] px-[10px] flex items-center justify-center hover:bg-tedja-black transition-all duration-300">
                            <span class="font-semibold group-hover:text-white transition-all duration-300">40%</span>
                        </a>
                        <a href="#" data-percentage="50" class="dp-option group relative rounded-[14px] border border-tedja-border py-[14px] px-[10px] flex items-center justify-center hover:bg-tedja-black transition-all duration-300">
                            <span class="font-semibold group-hover:text-white transition-all duration-300">50%</span>
                        </a>
                        <a href="#" data-percentage="60" class="dp-option group relative rounded-[14px] border border-tedja-border py-[14px] px-[10px] flex items-center justify-center hover:bg-tedja-black transition-all duration-300">
                            <span class="font-semibold group-hover:text-white transition-all duration-300">60%</span>
                        </a>
                        <a href="#" data-percentage="80" class="dp-option group relative rounded-[14px] border border-tedja-border py-[14px] px-[10px] flex items-center justify-center hover:bg-tedja-black transition-all duration-300">
                            <span class="font-semibold group-hover:text-white transition-all duration-300">80%</span>
                        </a>
                    </div>
                </section>
                <section id="KPR-Payment-Details" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-4">
                    <div class="flex items-center justify-between">
                    ...
                    <div class="flex flex-col gap-4" id="KPRPaymentDetails">
                        ...
                        <div class="flex flex-col gap-4">
                            <div class="flex items-center justify-between">
                                ...
                                <strong class="font-semibold"><span id="down-payment-amount">Rp 0</span> (<span id="down-payment-percent">0%</span>)</strong>
                            </div>
                            <div class="flex items-center justify-between">
                                <div class="flex items-center gap-2">
                                    <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                ...
                <form action="{{ route('front.interest.submitted') }}" method="POST" enctype="multipart/form-data" id="Request-Mortage" class="border border-[#F2F2F4] bg-white !h-fit w-full p-5 rounded-[20px] flex flex-col gap-5">
                    @csrf
                    ...
                    <hr class="border-[#F2F2F4]">
                    <button type="submit" class="rounded-full py-[14px] px-5 bg-tedja-green w-full text-center font-semibold">Request for Mortgage Now</button>
                </form>
            </div>
        </div>
        @endsection
