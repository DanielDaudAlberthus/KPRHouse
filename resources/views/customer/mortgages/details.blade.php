                ...
                <div class="flex flex-col gap-5 py-5 pl-5 rounded-[30px] border border-[#F2F2F4] bg-white">
                    <div class="flex items-center gap-4 pr-5">
                        <section id="Hero"
                            ...
                            <img src="{{ asset('assets/images/thumbnails/mortgage-details.png') }}" alt="image"
                            ...
                            <section id="Title" class="flex items-center justify-between">
                                <div class="flex flex-col gap-[6px]">
                                    ...
                                    <div class="flex items-center gap-[6px]">
                                        <img src="{{ asset('assets/images/icons/location.svg') }}" alt="icon" class="shrink-0 size-6">
                                        <p class="font-semibold">
                                ...
                                @if ($mortgageRequest->status == 'Waiting for Bank')
                                    ...
                                    @elseif ($mortgageRequest->status == 'Approved')
                                        ...
                                        @elseif ($mortgageRequest->status == 'Rejected')
                                            <span class="bg-tedja-red rounded-full py-[6px] px-[10px] font-semibold">Rejected</span>
                                        @endif
                            </section>
                    ...
                    <div class="ContainerTabs">
                            <div id="TabButtons" class="flex items-center gap-[12px] pr-5">
                                <button type="button"
                                    ...
                                    <h3 class="font-semibold text-[#FAFAFA] group-hover:text-[#FAFAFA] transition-all duration-300">Details</h3>
                                </button>
                                <button type="button"
                                    ...
                                    <h3 class="font-semibold text-tedja-black group-hover:text-[#FAFAFA] transition-all duration-300">Installments</h3>
                                </button>
                                <button type="button"
                                    class="rounded-full group bg-white border border-tedja-black py-[12px] px-[24px]  hover:bg-tedja-black transition-all duration-300">
                                    <h3 class="font-semibold text-tedja-black group-hover:text-[#FAFAFA] transition-all duration-300">Guidance</h3>
                                </button>
                                <button type="button"
                                    class="rounded-full group bg-white border border-tedja-black py-[12px] px-[24px]  hover:bg-tedja-black transition-all duration-300">
                                    <h3 class="font-semibold text-tedja-black group-hover:text-[#FAFAFA] transition-all duration-300">Agents</h3>
                                </button>
                            </div>
                        <div class="TabValues mt-5">
                            <section id="ContainerDetails">
                                <div class="grid grid-cols-2 gap-4">
                                    <div class="flex-col flex gap-4">
                                        <section id="PriceDetails" class="border border-[#F2F2F4] p-5 rounded-[20px] flex flex-col gap-4">
                                        ...
                                        <section id="KPRPaymentDetails" class="border border-[#F2F2F4] p-5 rounded-[20px] flex flex-col gap-4">
                                            ...
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        Rp {{ number_format($mortgageRequest->dp_total_amount , 0, '', '.') }} ({{ $mortgageRequest->dp_percentage }}%)
                                                    </strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                    ...
                                    <div class="flex flex-col gap-[10px]">
                                        <section id="BankKPRDetails" class="border border-[#F2F2F4] p-5 rounded-[20px] flex flex-col gap-4">
                                            ...
                                            <div class="bank flex items-center gap-5">
                                                <div class="w-[99.4px] h-[70px] shrink-0 flex justify-center items-center">
                                                    <img src="{{ Storage::url($mortgageRequest->interestModel->bank->photo) }}" alt="image" class="w-full h-full object-contain">
                                                </div>
                                                <div class="flex flex-col gap-[2px]">
                                                    <div class="flex items-center gap-[2px]">
                                                        ...
                                                        <img src="{{ asset('assets/images/icons/verify-blue-fill.svg') }}" alt="icon" class="size-5 shrink-0">
                                                    </div>
                                                    <p class="text-sm leading-[21px] text-tedja-secondary">Dipercaya jutaan nasabah</p>
                                                </div>
                                            </div>
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center justify-between">
                                                ...
                                                <div class="flex items-center justify-between">
                                                    ...
                                                    <strong class="font-semibold">
                                                        {{ $mortgageRequest->duration }} Years</strong>
                                                </div>
                                                <div class="flex items-center justify-between">
                                                    <div class="flex items-center gap-2">
                                                        <img src="{{ asset('assets/images/icons/note.svg') }}" alt="icon" class="size-6 shrink-0">
                                        ...
                                        <section id="YouveSubmittedDocuments" class="border border-[#F2F2F4] p-5 rounded-[20px] flex flex-col gap-4">
                                            <h4 class="font-semibold text-lg leading-[27px]">You’ve submitted documents:</h4>
                                            <div class="flex flex-col gap-4">
                                                <div class="flex items-center gap-[6px]">
                                            ...
                                            <div class="flex items-center gap-[6px] pl-[7px]">
                                                <img src="{{ asset('assets/images/icons/security-safe-blue-fill.svg') }}" alt="icon" class="size-6 shrink-0">
                                ...
                                <section id="NotAvailable" class="py-[40px] flex justify-center">
                                    <div class="flex flex-col gap-5 w-[460px] mx-auto">
                                        <div class="flex flex-col gap-[12px]">
                                            ...
                                            <p class="leading-7 text-center">Status mortgage anda masih dalam proses sehingga anda belum dapat melakukan pembayaran installments pada cicilan KPR rumah tersebut, mohon bersabar.</p>
                                        </div>
                                        <a href="">
                                            <div class="bg-tedja-green rounded-full font-semibold w-fit mx-auto py-[14px] px-5">Call Tedja Sales</div>
                                        </a>
                                    </div>
                                </section>
                                @else
                                    ...
                                    <div class="flex flex-col gap-5">
                                        ...
                                        <div class="flex items-center justify-between p-[10px] rounded-[30px] border border-[#F2F2F4]">
                                            <div class="flex items-center gap-[54px]">
                                                ...
                                                <div class="flex flex-col gap-[2px]">
                                                    ...
                                                    <strong class="font-bold">
                                                        Rp {{ number_format($installment->grand_total_amount, 0, '', '.') }}
                                                    </strong>
                                                </div>
                                            </div>
                                            ...
                                            <div class="flex flex-col gap-[2px]">
                                                ...
                                                <strong class="font-bold">
                                                    Payment of {{ $installment->no_of_payment }}
                                                </strong>
                                            </div>
                                            <div class="flex flex-col gap-[2px]">
                                            ...
                                            Lorem ipsum dolor sit, amet consectetur adipisicing elit. Maiores nobis unde nemo ut sunt ratione esse, dicta dignissimos ipsa atque praesentium saepe et rem officiis minus? Quod explicabo necessitatibus exercitationem.
                            ...
                            <section id="ContainerGuidance" class="px-5">
                                <div class="flex flex-col gap-2">
                                    ...
                                    <p class="leading-[28px] text-takeshi-text-gray">Lorem ipsum dolor, sit amet consectetur adipisicing
